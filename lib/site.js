...
export const site = {
  ...
  toolsTiers: [
    ...
    },
    {
      ...
      cadence: "per month",
      highlight: true,
      features: ["Unlimited runs", "All tools + early access", "Full job history", "Email reports", "Priority support"],
      cta: "Upgrade to Pro",
    ...
    },
    {
      ...
      cadence: "per month",
      highlight: false,
      features: ["Everything in Pro", "Team accounts", "Custom report branding", "API access", "Dedicated support"],
