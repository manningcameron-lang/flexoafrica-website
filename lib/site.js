...
export const site = {
  ...
  contact: {
    ...
    // Cities and countries where we can produce plates.
    serviceLocations: [
      { label: "Durban",      country: "South Africa" },
      { label: "Cape Town",   country: "South Africa" },
      { label: "Gauteng",     country: "South Africa" },
      { label: "East London", country: "South Africa" },
