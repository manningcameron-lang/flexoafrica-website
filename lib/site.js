...
export const site = {
  ...
  contact: {
    ...
    mapsQuery: "Assagay, KwaZulu-Natal, South Africa",
  },

  stats: [
    { label: "Customers served", value: "50+" },
    { label: "Jobs delivered", value: "3,400+" },
    { label: "Supplier partners", value: "Polyflex & Stallion" },
    { label: "Based in", value: "Assagay, KZN" },
  ],
